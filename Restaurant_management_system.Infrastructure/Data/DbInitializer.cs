    ...
    public class DbInitializer
    {
        public static void Initialize(RestaurantContext context)
        {
            ...
            var ingredients = new IngredientEntity[]
            {
                ...
                new IngredientEntity{ ID=4,  Name="Pepper", Price=2 },
                ...
                new IngredientEntity{ ID=10, Name="Salmon", Price=240 },
                new IngredientEntity{ ID=11, Name="Mackerel", Price=200 },
                new IngredientEntity{ ID=12, Name="Parmesan", Price=90 },
                new IngredientEntity{ ID=13, Name="Milk", Price=70 },
                new IngredientEntity{ ID=14, Name="Tomato", Price=35 },
                new IngredientEntity{ ID=15, Name="Cucumber", Price=18 },
                new IngredientEntity{ ID=16, Name="Salad", Price=6 },
                new IngredientEntity{ ID=17, Name="Bacon", Price=87 },
                new IngredientEntity{ ID=18, Name="Egg", Price=62 },
                new IngredientEntity{ ID=19, Name="Avocado", Price=117 },
                new IngredientEntity{ ID=20, Name="Beef", Price=140 },
                new IngredientEntity{ ID=21, Name="Pork", Price=135 },
                new IngredientEntity{ ID=22, Name="Flour", Price=43 },
                new IngredientEntity{ ID=23, Name="Sugar", Price=87 },
                new IngredientEntity{ ID=24, Name="Creamy filling", Price=112 },
                new IngredientEntity{ ID=25, Name="Bread", Price=10 },
                new IngredientEntity{ ID=26, Name="Cheese", Price=50 },
                new IngredientEntity{ ID=27, Name="Pork cutlet", Price=166 }
            };
