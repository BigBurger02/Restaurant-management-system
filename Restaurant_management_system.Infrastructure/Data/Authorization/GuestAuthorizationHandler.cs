...
public class GuestAuthorizationHandler : AuthorizationHandler<OperationAuthorizationRequirement, object>
{
                                                    ...
                                                    object resource)// resourse is gag
    {
        ...
        if (context.User.IsInRole(RolesEnumeration.Guest.ToString()))
        {
